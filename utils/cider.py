...
class CiderScorer(object):
    ...
    def __init__(self, test=None, refs=None, n=4, sigma=6.0, cider_cached=None):
        ''' singular instance '''
        self.n = n
        self.sigma = sigma
        self.crefs = []
