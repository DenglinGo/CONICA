...
@dataclass
class DataArguments:
    feature_path: str = field(default="/dataset/caption/flicker-30k/features/ViT-L/14@336px",
    ...
    dataset_csv: str = field(default="/dataset/caption/flickr30k.csv",
    ...
    train_corpus_path: str = field(default="/dataset/caption/cache_document_frequency/flickr30k-train-words.p",
