...
@dataclass
class DataArguments:
    feature_path: str = field(default="/home/smart-solution-server-001/Documents/dataset_fast/caption/mscoco/features/ViT-L/14@336px",
    ...
    dataset_csv: str = field(default="/dataset/caption/mscoco.csv",
    ...
    train_corpus_path: str = field(default="/dataset/caption/cache_document_frequency/coco-train-words.p",
    ...
    coco_eval_json: str = field(default="/dataset/caption/captions_val2014.json",
