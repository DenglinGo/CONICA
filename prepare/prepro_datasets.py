...
if __name__ == "__main__":
    ...
    parser.add_argument('-karpathy_split_json', type=str, default="/dataset/caption/karpathy_split/dataset_flickr30k.json",
                        help="path of karpathy split json")
    parser.add_argument('-output_file', type=str, default="/dataset/caption/karpathy_split/flickr30k.csv",
