...
if __name__ == "__main__":
    ...
    parser.add_argument('-dataset_path', type=str, default="/dataset/caption/mscoco.csv",
                        help="path of karpathy split json")
    parser.add_argument('-output_file', type=str, default="../conica-clip",
    ...
    if args.pretrained_tokenizer_name is not None:
        ...
        # be consistent with original tokenizer of CLIP
